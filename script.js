...
function ageInDays(){
    ...
    let date=new Date();
    let ageindays=((date.getFullYear()-(birthdate)-1)*365)+((12-(birthmonth-(date.getMonth()+1)))*31)+(31-(birthday-date.getDay()))-12;
...
function ageInHours(){
    ...
    let birthday=prompt("ayin neçəsi dogulubsuz?")
    let date=new Date();
    let ageinhours=(((((date.getFullYear()-(birthdate)-1)*365)+((12-(birthmonth-(date.getMonth()+1)))*31)+(31-(birthday-date.getDay())))*24)-12*24);
    let h1=document.createElement('h1');
...
function ageInMinutes(){
    ...
    let date=new Date();
    let ageinminutes=(((((date.getFullYear()-(birthdate)-1)*365)+((12-(birthmonth-(date.getMonth()+1)))*31)+(31-(birthday-date.getDay())))*24)*60)-12*24*60;
    let h1=document.createElement('h1');
